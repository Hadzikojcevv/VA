    ...
    <>
      <div className="hidden lg:flex flex-col lg:flex-row h-screen overflow-hidden py-[88px]">
        ...
        <div className="w-full lg:w-[30%] h-[100dvh] sticky top-0 bg-white p-8 shadow-lg overflow-hidden lg:overflow-auto order-1 lg:order-2 pb-[100px] scrollbar-hidden">
          <h1 className="text-3xl lg:text-5xl tracking-tighter font-black mb-6">
            {project?.title}
          </h1>

          <p className="text-base lg:text-xl font-bold text-main-dark/80">
            Date:{" "}
            <span className="text-main-dark/60 tracking-tighter font-semibold text-lg lg:text-xl">
              {project?.date}
            </span>
          </p>
          ...
          {project?.desc1 && (
            <p className="text-main-dark/80 text-sm md:text-base">
              {project.desc1}
            </p>
          )}

          {project?.desc2 && (
            <p className="text-main-dark/80 my-4 lg:my-6 text-sm md:text-base">
              {project.desc2}
            </p>
          )}
      ...
      <div className="lg:hidden py-[88px] w-[90%] m-auto">
        <div className="relative">
          ...
          />
          <h1 className="text-4xl lg:text-5xl tracking-tighter font-black mb-6">
            {project?.title}
          </h1>
